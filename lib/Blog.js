/**
 * Library for Blog, including its producer/consumer functions.
 *
 * General thoughts:
 *   Producer:
 *   - retrieve a list of urls to be requested
 *   - wrap those urls to rabbitmq message, publish the message
 *
 *   Consumer:
 *   - receive the message already routed by RabbitHub
 *     (monitoring by RabbitDispatcher)
 *   - begin the process of parsing/saving
 */
 ...
 * Objectif is to find exactly how many pages, thus a list of urls to be consumed.
 * Publish a message per url to RabbitMQ
 *
 * @param {Object}
